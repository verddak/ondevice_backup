...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train SimpleCNN on HBM data')
    # Data
    ...
    # Model
    parser.add_argument('--model_name', type=str, default='simple_cnn',help='Model name for saving')
    # Training
